(* OASIS_START *)
(* DO NOT EDIT (digest: a1a2eb486e058f7778746837e24c6a34) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            "-use-ocamlfind";
            "-plugin-tags";
            "'package(js-build-tools.ocamlbuild_goodies), package(ppx_driver.ocamlbuild), package(ocaml_plugin.ocamlbuild)'"
         ];
     test = [];
     doc = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        ["batched_mtimes_stubs.c"; "digest_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "5\186\179\164\200\2036y\151\161\183Z6lzJ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
